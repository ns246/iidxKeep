...
<div class="mb-5">
    <table class="table caption-top">
        ...
        <tr>
            ...
            {{-- クリアランプ BIGGINER --}}
            <td class="lamp" @if ($music_data?->sp_b_djlevel !== $type) style='display:none;' @endif>
            ...
            <td class="text-center"
                style="background-color: rgba(121,209,0,.3);@if ($music_data?->sp_b_djlevel !== $type) display:none; @endif">
                @if (optional($score_data)->{'sp_b_lv'} == '')
                    --
                @else
            ...
            {{-- クリアタイプ BIGGINER --}}
            <td @if ($music_data?->sp_b_djlevel !== $type) style='display:none;' @endif>
                @if ($music_data->sp_b_cleartype == 'NO PLAY')
            ...
            {{-- スコア BIGGINER --}}
            <td style="text-align: center;line-height: 0.9;@if ($music_data?->sp_b_djlevel !== $type) display:none; @endif">
            ...
            {{-- スコアグラフ BIGGINER --}}
            <td style="width:100px;padding:0 0 0 0;@if ($music_data?->sp_b_djlevel !== $type) display:none; @endif">
            ...
            <td @if ($music_data?->sp_b_djlevel !== $type) style='display:none;' @endif>{{ $music_data->sp_b_misscount }}</td>
        </tr>
        <tr>
            {{-- クリアランプ NORMAL --}}
            <td class="lamp" @if ($music_data?->sp_n_djlevel !== $type) style='display:none;' @endif>
            ...
            {{-- レベル NORMAL --}}
            <td class="text-center"
                style="background-color: rgba(32,168,255,.3);@if ($music_data?->sp_n_djlevel !== $type) display:none; @endif">
                @if (optional($score_data)->{'sp_n_lv'} == '')
                    --
                @else
            ...
            {{-- クリアタイプ NORMAL --}}
            <td @if ($music_data?->sp_n_djlevel !== $type) style='display:none;' @endif>
                @if ($music_data->sp_n_cleartype == 'NO PLAY')
            ...
            {{-- スコア NORMAL --}}
            <td style="text-align: center;line-height: 0.9;@if ($music_data?->sp_n_djlevel !== $type) display:none; @endif">
            ...
            {{-- スコアグラフ NORMAL --}}
            <td style="width:100px;padding:0 0 0 0;@if ($music_data?->sp_n_djlevel !== $type) display:none; @endif">
                <div class="div_td rate">
                    <div class="rate_wrapper">
                        <div class="rate_graph">
                            <div class="bar_area border">
            ...
            <td @if ($music_data?->sp_n_djlevel !== $type) style='display:none;' @endif>{{ $music_data->sp_n_misscount }}</td>
        </tr>
        {{-- HYPER --}}
        <tr>
            {{-- クリアランプ HYPER --}}
            <td class="lamp" @if ($music_data?->sp_h_djlevel !== $type) style='display:none;' @endif>
            ...
            <td class="text-center"
                style="background-color: rgba(255,174,0,.3);@if ($music_data?->sp_h_djlevel !== $type) display:none; @endif">
                @if (optional($score_data)->{'sp_h_lv'} == '')
                    --
                @else
            ...
            {{-- クリアタイプ HYPER --}}
            <td @if ($music_data?->sp_h_djlevel !== $type) style='display:none;' @endif>
                @if ($music_data->sp_h_cleartype == 'NO PLAY')
            ...
            <td class="text-nowrap"
                style="text-align: center;line-height: 0.9;@if ($music_data?->sp_h_djlevel !== $type) display:none; @endif">
            ...
            {{-- スコアグラフ HYPER --}}
            <td style="width:100px;padding:0 0 0 0;@if ($music_data?->sp_h_djlevel !== $type) display:none; @endif">
                <div class="div_td rate">
                    <div class="rate_wrapper">
                        <div class="rate_graph">
                            <div class="bar_area border">
            ...
            <td @if ($music_data?->sp_h_djlevel !== $type) style='display:none;' @endif>{{ $music_data->sp_h_misscount }}
            </td>
        </tr>
        {{-- ANOTHER --}}
        <tr>
            {{-- クリアランプ ANOTHER --}}
            <td class="lamp" @if ($music_data?->sp_a_djlevel !== $type) style='display:none;' @endif>
            ...
            <td class="text-center"
                style="background-color: rgba(255,0,0,.3);@if ($music_data?->sp_a_djlevel !== $type) display:none; @endif">
                @if (optional($score_data)->{'sp_a_lv'} == '')
                    --
                @else
            ...
            {{-- クリアタイプ ANOTHER --}}
            <td @if ($music_data?->sp_a_djlevel !== $type) style='display:none;' @endif>
                @if ($music_data->sp_a_cleartype == 'NO PLAY')
            ...
            {{-- スコア ANOTHER --}}
            <td class="text-nowrap"
                style="text-align: center;line-height: 0.9;@if ($music_data?->sp_a_djlevel !== $type) display:none; @endif">
            ...
            {{-- スコアグラフ ANOTHER --}}
            <td style="width:100px;padding:0 0 0 0;@if ($music_data?->sp_a_djlevel !== $type) display:none; @endif">
                <div class="div_td rate">
                    <div class="rate_wrapper">
                        <div class="rate_graph">
                            <div class="bar_area border">
            ...
            <td @if ($music_data?->sp_a_djlevel !== $type) style='display:none;' @endif>{{ $music_data->sp_a_misscount }}
            </td>
        </tr>

        {{-- LEGGENDARIA --}}
        <tr>
            <td class="lamp"@if ($music_data?->sp_l_djlevel !== $type || $score_data?->{'sp_l_lv'} == '') style='display:none;' @endif>
                {{-- クリアランプ LEGGENDARIA --}}
            ...
            <td class="text-center"
                style="background-color: rgba(206,0,214,.3);@if ($music_data?->sp_l_djlevel !== $type || $score_data?->{'sp_l_lv'} == '') display:none; @endif">
                @if (optional($score_data)->{'sp_l_lv'} == '')
                    --
                @else
            ...
            {{-- クリアタイプ LEGGENDARIA --}}
            <td @if ($music_data?->sp_l_djlevel !== $type || $score_data?->{'sp_l_lv'} == '') style='display:none;' @endif>
            ...
            {{-- スコア LEGGENDARIA --}}
            <td style="text-align: center;line-height: 0.9;@if ($music_data?->sp_l_djlevel !== $type || $score_data?->{'sp_l_lv'} == '') display:none; @endif">
            ...
            {{-- スコアグラフ LEGGENDARIA --}}
            <td style="width:100px;padding:0 0 0 0;@if ($music_data?->sp_l_djlevel !== $type || $score_data?->{'sp_l_lv'} == '') display:none; @endif">
                <div class="div_td rate">
                    <div class="rate_wrapper">
                        <div class="rate_graph">
                            <div class="bar_area border">
            ...
            <td @if ($music_data?->sp_l_djlevel !== $type || $score_data?->{'sp_l_lv'} == '') style='display:none;' @endif>{{ $music_data->sp_l_misscount }}
            </td>
        </tr>
        @endforeach
    </table>
