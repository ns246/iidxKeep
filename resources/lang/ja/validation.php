...
return [
    ...
    */
    ...
    'custom' => [
        'name' => [
            'required' => '氏名は必ず入力してください。',
			'max'=> '氏名は10文字以内で入力してください。'
        ],
		'kana'=>[
            'required' => 'フリガナは必ず入力してください。',
			'max'=> 'フリガナは10文字以内で入力してください。'
		],
		'tel'=>[
            'numeric' => '電話番号には数字を入力してください。',
			'digits_between'=>'電話番号は11桁以内で入力してください。'
		],
		'email'=>[
            'required' => 'メールアドレスは必ず入力してください。',
			'email' => 'メールアドレスには有効なメールアドレスを指定してください。',
			'max'=> 'メールアドレスは100文字以内で入力してください。'
		],
		'body'=>[
            'required' => 'お問い合わせ内容は必ず入力してください。',
		],
    ],
